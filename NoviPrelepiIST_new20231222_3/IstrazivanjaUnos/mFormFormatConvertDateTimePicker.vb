...
Public Class mFormFormatConvertDateTimePicker
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        '
        'mFormFormatConvertDateTimePicker
        '
        ...
        Me.Name = "mFormFormatConvertDateTimePicker"
...
#End Region
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.what.Trim.ToUpper = "CONVERT" Then
            Me.Label1.Text = Me.what + " to DatetimPicker"
        ElseIf Me.what.Trim.ToUpper = "FORMAT" Then
            ...
            If dt.Rows.Count = 1 Then
                ...
                End Try
            End If
            Me.Label1.Text = Me.what + " DatetimPicker"
        End If
    ...
    Function getDTC() As System.Data.DataTable
        ...
        Dim strSQl As String = "select vs" +
                ...
                " and cast (vod as date)='" + Convert.ToDateTime(pp(1).Trim).ToString("yyyy/MM/dd", System.Globalization.CultureInfo.InvariantCulture) + "' and izraz like '%datetimepicker%'"
    ...
    Sub fformatConvert()
        ...
        sqlIST = "update istpolja set" + nvrd +
                " vs='" + pvs + "',izraz='datetimepicker',tip='datetime'" +
