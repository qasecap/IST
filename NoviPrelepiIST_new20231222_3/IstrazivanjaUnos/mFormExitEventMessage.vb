...
Public Class mFormExitEventMessage
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label50.Text = "Message If"
        '
        'mFormExitEventMessage
        '
...
#End Region
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Label1.Text = "Message on field " + pp(2).Trim + "    Type: " + CStr(pp(5)).Trim + ", MaxLength= " + CStr(pp(6)).Trim
    End Sub
    ...
    Sub getMetaDataPane()
        ...
        For i As Integer = 0 To pp.GetUpperBound(0)
            ...
            If pp(i).Length > 4 AndAlso pp(i).Trim.ToUpper.IndexOf("MSGIF") >= 0 OrElse pp(i).Length > 8 AndAlso pp(i).Trim.ToUpper.IndexOf("PORUKAAKO") >= 0 Then
                msgIf = pp(i).Trim.ToUpper.Replace("MSGIF=", "").Replace("PORUKAAKO=", "").Split("$")
            ElseIf pp(i).Length > 4 AndAlso pp(i).Trim.ToUpper.IndexOf("MSGIS") >= 0 OrElse pp(i).Length > 7 AndAlso pp(i).Trim.ToUpper.IndexOf("PORUKAJE") >= 0 Then
                msgis = pp(i).Trim.ToUpper.Replace("MSGIS=", "").Replace("PORUKAJE=", "").Split("$")
        ...
        For i As Integer = 0 To msgIf.GetUpperBound(0)
        ...
        For i As Integer = 0 To msgIf.GetUpperBound(0)
            ...
            If Not tb Is Nothing Then DirectCast(tb, TextBox).Text = msgIf(i).Trim
        Next

        For i As Integer = 0 To msgis.GetUpperBound(0)
            Dim tb As Control = NadjiKontrolu(Me, "pMsg" + CStr(i + 1).Trim)
            If Not tb Is Nothing Then DirectCast(tb, TextBox).Text = msgis(i).Trim
        Next
    ...
    Private Sub btn_Click(sender As Object, e As EventArgs) Handles btn.Click
        ...
        For k As Integer = 1 To br
            ...
            If DirectCast(tb, TextBox).Text <> "" Then msgis = msgis + tb.Text + "$"
        Next
        If msgis <> "" Then
            msgis = "MsgIs=" + msgis.TrimEnd("$") + ";"
            mmsg = mmsg + msgis
        End If
