...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FormLogLKNovo))
        ...
        Me.SplitContainer1.Location = New System.Drawing.Point(12, 20)
        ...
        Me.SplitContainer1.Size = New System.Drawing.Size(856, 410)
        ...
        Me.ButtonTrazi.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch
        ...
        Me.GB.ForeColor = System.Drawing.SystemColors.ControlText
        ...
        Me.ButtonUradi.Location = New System.Drawing.Point(127, 361)
        ...
        Me.UserControlVremenskaTacka1.Location = New System.Drawing.Point(127, 391)
...
#End Region
    ...
    Public Sub New(ByVal vt As IstrazivanjaVremenskaTackaControl.UserControlVremenskaTacka,
        ...
        Else
            ...
            dt.Rows.Add(New Object() {"Error number", "rbrgreske"})
            dt.Rows.Add(New Object() {"Error title", "nazivGreske"})
            dt.Rows.Add(New Object() {"Error", "Greska"})
            dt.Rows.Add(New Object() {"User", "ko_insert"})
            dt.Rows.Add(New Object() {"Date", "datum_insert"})
    ...
    Private Sub ButtonTrazi_Click(sender As Object, e As System.EventArgs) Handles ButtonTrazi.Click
        ...
        nizS = nizS.Replace("datum_insert", "CONVERT(varchar,datum_insert, 111)+ ' " & "' + left(CONVERT(varchar, datum_insert, 108),5)")
