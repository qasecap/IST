'Option Strict Off
Public Class mFormConvertEmptySpace
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Convert Empty Space To Label"
        '
        'Panel1
        '
        ...
        Me.Name = "mFormConvertEmptySpace"
        ...
        Try
            If Me.lbD.CheckedItems.Count > 0 Then
                For i As Integer = 0 To Me.lbD.CheckedItems.Count - 1
                    strIST = strIST + "update ISTPolja set izraz='$''label''' where sifist=N'" + sifist +
