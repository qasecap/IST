...
Public Class mFormEnterEventVisibleFalse
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label50.Text = "Visible false If"
        '
        'mFormEnterEventVisibleFalse
        '
        ...
        Me.Name = "mFormEnterEventVisibleFalse"
...
#End Region
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me.Label1.Text = "On Enter event on field " + pp(2).Trim + "    Type: " + CStr(pp(5)).Trim + ", MaxLength= " + CStr(pp(6)).Trim + "     VISIBLE FALSE"
    End Sub
    ...
    Sub getMetaDataPane()
        ...
        Dim visiblefalseif() As String = {}
        Dim visiblefalse() As String = {}

        For i As Integer = 0 To pp.GetUpperBound(0)

            If pp(i).Length > 13 AndAlso pp(i).Trim.ToUpper.IndexOf("VISIBLEFALSEIF") >= 0 Then
                visiblefalseif = pp(i).Trim.ToUpper.Replace("VISIBLEFALSEIF=", "").Split("$")
            ElseIf pp(i).Length > 11 AndAlso pp(i).Trim.ToUpper.IndexOf("VISIBLEFALSE") >= 0 Then
                visiblefalse = pp(i).Trim.ToUpper.Replace("VISIBLEFALSE=", "").Split("$")
            ElseIf pp(i).Trim <> "" Then
                enterEventOst = enterEventOst + pp(i) + ";"
            End If
        Next

        For i As Integer = 0 To visiblefalseif.GetUpperBound(0)
        ...
        For i As Integer = 0 To visiblefalseif.GetUpperBound(0)
            ...
            If Not tb Is Nothing Then DirectCast(tb, TextBox).Text = visiblefalseif(i).Trim
        Next

        For i As Integer = 0 To visiblefalse.GetUpperBound(0)
            Dim tb As Control = NadjiKontrolu(Me, "tb" + CStr(i + 1).Trim)
            If Not tb Is Nothing Then DirectCast(tb, TextBox).Text = visiblefalse(i).Trim
        Next
    ...
    Private Sub btn_Click(sender As Object, e As EventArgs) Handles btn.Click
        ...
        For k As Integer = 1 To 20
            ...
            If Not tb Is Nothing AndAlso DirectCast(tb, TextBox).Text <> "" Then
                visiblefalseif = visiblefalseif + tb.Text + "$"
                br = br + 1
            End If
        Next
        If visiblefalseif <> "" Then
            visiblefalseif = "visiblefalseif=" + visiblefalseif.TrimEnd("$") + ";"
            kkon = kkon + visiblefalseif
        End If
        ...
        For k As Integer = 1 To br
            ...
            If DirectCast(tb, TextBox).Text <> "" Then visiblefalse = visiblefalse + tb.Text + "$"
        Next
        If visiblefalse <> "" Then
            visiblefalse = "visiblefalse=" + visiblefalse.TrimEnd("$") + ";"
            kkon = kkon + visiblefalse
        End If
